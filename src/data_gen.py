...
UNIQUE_RUN_ID = f"{os.getpid()}_{uuid.uuid4().hex[:6]}"
...
class Config:
    ENGINE_PATH = r"C:\Users\ethan\Downloads\ChessHacks\e\ChessHacks\my-chesshacks-bot\src\stockfish-windows-x86-64-avx2.exe"
    ...
    OUTPUT_DIR = r"C:\Users\ethan\Downloads\ChessHacks\e\ChessHacks\my-chesshacks-bot\processed"
    ...
    try:
        while True:
            ...
            if len(buffer) >= cfg.SHARD_SIZE:
                ...
                save_path = out / f"shard_{UNIQUE_RUN_ID}_{shard_id:05d}.npz"
